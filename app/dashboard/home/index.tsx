...
import { Animated, Easing, Image, RefreshControl, ScrollView, StyleSheet, TouchableOpacity, View } from "react-native";
...
const DashboardScreen = () => {
    ...
    const handleSelectOutlet = React.useCallback(() => {
        closeDrawer();
        router.push("/dashboard/select-branch");
    }, [closeDrawer, router]);
    ...
    return (
        <View style={styles.container}>
            <DashboardHeader onPressMenu={openDrawer} />
            <ScrollView
                ...
                <View style={styles.sectionCard}>
                    <View style={styles.sectionHeader}>
                        ...
                        <View style={styles.linkContainer}>
                            ...
                            <Ionicons name="chevron-forward-outline" size={18} color={Colors[colorScheme].icon} />
                        </View>
                    </View>
                    <ScrollView
                        horizontal
