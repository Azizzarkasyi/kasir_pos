...
export default function RootLayout() {
  ...
  useEffect(() => {
    if (fontsLoaded) {
      // Show custom splash screen for 3 seconds (matching animation duration)
      ...
      <GestureHandlerRootView style={{ flex: 1 }}>
        <View style={{ flex: 1 }}>
          <Stack>
            ...
            />
            <Stack.Screen
              name="dashboard/setting/printer-test"
              options={{ headerShown: false, title: "Printer Test" }}
            />
            <Stack.Screen
            ...
            />
            <Stack.Screen
              name="dashboard/setting/scanner-test"
              options={{ headerShown: false, title: "Scanner" }}
            />
            <Stack.Screen
